...
The `churn` dataset contains 20 variables, and 5000 observations.
...
**Interpretation:** There is $95\%$ probability that the true population mean is included in $[1.534181, 1.606619]$.
...
**Interpretation:** There is $95\%$ probability that the true population mean is included in $[0.9084033, 2.0915967]$.
...
**Statistical conclusion:** Given that p-value = $0.3926\%$ < $\alpha/2 = 2.5\%$, there is sufficient evidence found to reject the $H_0$, and infer that population mean of the number of customer service calls is different from $2.4$.
...
**Statistical conclusion:** Given that p-value = $0.01403\%$ < $\alpha/2 = 2.5\%$, there is sufficient evidence found to reject the $H_0$, and infer that population mean of the number of customer cervice calls is different from $1.5$.
...
**Interpretation:** There is $95\%$ probability that the true population proportion is included in $[0.1319201, 0.1514362]$.
...
**Statistical conclusion:** Given that p-value = $60.45\%$ > $\alpha = 1\%$, there is insufficient evidence found to reject the $H_0$, and infer that population proportion of churners is less than $0.14$.
...
**Statistical conclusion:** Given that p-value = $2.2 * 10 ^{-14}\%$ < $\alpha/2 = 2.5\%$, there is sufficient evidence found to reject the $H_0$, and infer that the population mean of `customer.call` for churners versus non-churners is different from each other.
...
**Conclusion:** We can conclude statistical relationship between `customer.call` and `churn`, given that those of churners have 2.25 customers calls on average, that is significantly different from those of non-churners with 1.45 calls on average.
...
**Statistical conclusion:** Given that p-value = $2.2 * 10 ^{-14}\%$ < $\alpha = 2.5\%$, there is sufficient evidence found to reject the $H_0$, and infer that the correlation between `approved` and `spent` is not positive.
...
**Conclusion:**We cannot conclude with 2.5% statistical significance that the correlation between `approved` and `spent` is positive.
