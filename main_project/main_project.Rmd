---
title: '<center>Predicting employee turnover rate in the field of Data Science<center>'
subtitle: '<center>Data Wrangling Main Project<center>'
...
ggplot( data = data ) + 
  ...
  scale_fill_manual( values = c( "palevioletred1", "darkseagreen1" ) ) + 
  theme_new
# plot data as barchart with overlay
ggplot( data = data ) + 
...
# plot ROC curves, and get AUC vaules for variables
