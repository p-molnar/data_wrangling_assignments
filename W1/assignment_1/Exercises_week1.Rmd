...
* nominal variables: The dataset does not contain any nonimal variables.
...
ggplot( diamonds ) +
    ...
    coord_cartesian( ylim = c( 0, 30 ) )
```
There seems to be an unusual value for the x measure of the diamond. One of the measures of the diamond is 0mm, which is impossible. It probably meant in the data recording a missing value, or an invalid measure etc. To be finished.
