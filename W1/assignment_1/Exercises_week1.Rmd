...
The above scatterplot shows, that diamonds with width above 9mm tend to deviate from the bulk of the data, and although having an unusual width the diamond does not sell for proportionately higher price. Since variable `x` is just one of many independent variables that determines the price of a diamond, it is likely to be the case that unusual width diamonds that did not sell for proportionately higher price are of lower quality cut, colour or clarity.
